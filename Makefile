#############################################################################
# Makefile for building: WheatleyServer
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  WheatleyServer.pro
# Template: app
# Command: /usr/lib/arm-linux-gnueabihf/qt5/bin/qmake -o Makefile WheatleyServer.pro
#############################################################################
...
CXXFLAGS      = -pipe -lpthread -lwiringPi -O2 -std=c++0x -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I. -isystem /usr/include/arm-linux-gnueabihf/qt5 -isystem /usr/include/arm-linux-gnueabihf/qt5/QtWidgets -isystem /usr/include/arm-linux-gnueabihf/qt5/QtGui -isystem /usr/include/arm-linux-gnueabihf/qt5/QtNetwork -isystem /usr/include/arm-linux-gnueabihf/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/local/lib -lwiringPi -lQt5Widgets -lQt5Gui -lQt5Network -lQt5Core -lGLESv2 -lpthread 
AR            = ar cqs
RANLIB        = 
...
DIST          = /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		...
		WheatleyServer.pro main.cpp \
		server.cpp \
		RCSwitch.cpp
QMAKE_TARGET  = WheatleyServer
...
Makefile: WheatleyServer.pro /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/linux.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile WheatleyServer.pro
...
dist: 
	@test -d .tmp/WheatleyServer1.0.0 || mkdir -p .tmp/WheatleyServer1.0.0
	$(COPY_FILE) --parents $(DIST) .tmp/WheatleyServer1.0.0/ && $(COPY_FILE) --parents server.h RCSwitch.h .tmp/WheatleyServer1.0.0/ && $(COPY_FILE) --parents main.cpp server.cpp RCSwitch.cpp .tmp/WheatleyServer1.0.0/ && (cd `dirname .tmp/WheatleyServer1.0.0` && $(TAR) WheatleyServer1.0.0.tar WheatleyServer1.0.0 && $(COMPRESS) WheatleyServer1.0.0.tar) && $(MOVE) `dirname .tmp/WheatleyServer1.0.0`/WheatleyServer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/WheatleyServer1.0.0
...
moc_server.cpp: RCSwitch.h \
		server.h
	/usr/lib/arm-linux-gnueabihf/qt5/bin/moc $(DEFINES) -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I/home/pi/Projects/WheatleyServer/WheatleyServer -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtWidgets -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtNetwork -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I/usr/include/c++/4.9 -I/usr/include/arm-linux-gnueabihf/c++/4.9 -I/usr/include/c++/4.9/backward -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include -I/usr/local/include -I/usr/lib/gcc/arm-linux-gnueabihf/4.9/include-fixed -I/usr/include/arm-linux-gnueabihf -I/usr/include server.h -o moc_server.cpp
...
RCSwitch.o: RCSwitch.cpp RCSwitch.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o RCSwitch.o RCSwitch.cpp
